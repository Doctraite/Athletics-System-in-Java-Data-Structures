...
public String username;
            ...
            throws ServletException, IOException 
    {
        ...
        try
        {
         ...
         //Display Chat Room
         out.println("<html>  <head> <body bgcolor=\"blue\"> <meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\"> <title>Matsapha Municipality Company Profile</title>  </head>");
         out.println("<meta http-equiv=\"Content-Type\" content=\"text/html; charset=UTF-8\"> <center>");
         out.println("<h2>Hi ");
         out.println(username);
         out.println("<br> Athletes Social Media Section ");
